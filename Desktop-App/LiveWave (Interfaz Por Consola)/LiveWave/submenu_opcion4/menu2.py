from .Codigo_fun2 import main as main_tiepie
...
# Programa principal
def mostrar_menu_principal_tiepie():
    while True:
        print("\n--- MENÚ PRINCIPAL ---")
        print("1. Iniciar Captura Sensor Inductivo")
        print("2. Salir")

        try:
            opcion = int(input("Seleccione una opción: "))
            if opcion == 1:
                print("Iniciando captura de datos..., (Presione CONTROL + C para detener)")
                main_tiepie()
            elif opcion == 2:
